...
export default function CinematicIntro() {
  ...
  const backgroundImage =
    settings?.["intro_background_image_url"] || "/img/hero-01.jpg";
  ...
  // El audio intenta comenzar inmediatamente. Si el navegador móvil bloquea
  // autoplay con sonido, el primer toque/click/tecla en cualquier lugar de la
  // página lo desbloquea. No mostramos botones ni overlays.
  useEffect(() => {
  ...
  // Pre-carga únicamente la imagen editable de fondo. No acelera la intro.
  useEffect(() => {
  ...
  return (
    ...
    >
      <img
        ...
        fetchPriority="high"
        decoding="async"
        className={`absolute inset-0 h-full w-full object-cover object-center transition-all duration-[1800ms] ease-out ${
          stage >= 4 ? "scale-100 opacity-45" : "scale-110 opacity-0"
        }`}
      />
